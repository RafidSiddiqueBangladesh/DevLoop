            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="px-4 py-2 text-foreground">{formData.fullName}</p>
                )}
              </div>
              ...
              {/* Household Size */}
              <div>
                <label className="block text-sm font-medium mb-2">{t('auth.householdSize')}</label>
                {isEditing ? (
                  <select
                  ...
                  <p className="px-4 py-2 text-foreground">{formData.householdSize} people</p>
                )}
              </div>

              {/* Dietary Preferences */}
              <div>
                <label className="block text-sm font-medium mb-2">{t('auth.dietaryPreferences')}</label>
                {isEditing ? (
                  <input
                    type="text"
                  ...
                  <p className="px-4 py-2 text-foreground">{formData.dietaryPreferences}</p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="px-4 py-2 text-foreground">{formData.location}</p>
                )}
              </div>

              {/* Monthly Budget */}
              <div>
                <label className="block text-sm font-medium mb-2">Monthly Budget (BDT)</label>
                {isEditing ? (
                  <input
                    type="number"
                  ...
                  <p className="px-4 py-2 text-foreground">৳ {parseInt(formData.monthlyBudget).toLocaleString()}</p>
                )}
              </div>
